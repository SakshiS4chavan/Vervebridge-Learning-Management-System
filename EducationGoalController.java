...
import dto.EducationGoalDTO;
import dto.TopicDTO;
import dto.TypeOfTopicDTO;
import model.EducationGoal;
...
public class EducationGoalController {
	...
	private final EducationGoalService service;
	...
	public ResponseEntity<EducationGoal> update(@PathVariable("id") Long id, @RequestBody EducationGoal changedObject) {
		EducationGoal objectExist = ContextService.findOne(id).orElse(null);
		if (objectExist != null) {
			ContextService.save(changedObject);
